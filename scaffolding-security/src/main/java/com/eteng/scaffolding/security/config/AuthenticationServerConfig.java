...
import com.eteng.scaffolding.security.component.auth2.enhancer.CustomTokenEnhancer;
import com.eteng.scaffolding.security.component.auth2.granter.MobileTokenGranter;
...
public class AuthenticationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        endpoints.tokenStore(tokenStore())
                ...
                // 用于生成默认的ResourceOwnerPasswordTokenGranter,如果不配置将不能使用密码模式校验
